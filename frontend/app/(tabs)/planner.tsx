...
const styles = StyleSheet.create({
  ...
  dayNameSel: { color: Color.primaryBaseWhite },
  dayNum: {
    fontSize: FontSize.fs_22,
    fontFamily: FontFamily.dMSans,
    fontWeight: "500",
  ...
  dayNumSel: { color: Color.primaryBaseWhite },
  ...
  fab: {
    position: "absolute",
    bottom: 125, // tabBar bottom(30) + tabBar height(80) + 15px gap
    right: 20,
    width: 56,
    height: 56,
    borderRadius: 28,
    ...
    alignItems: "center",
    elevation: 12,
    shadowColor: Color.colorDodgerblue,
    shadowOffset: { width: 0, height: 4 },
    shadowOpacity: 0.45,
    shadowRadius: 10,
    zIndex: 100,
