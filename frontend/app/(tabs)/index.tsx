  ...
  const fetchWeather = async () => {
    try {
      ...
      setWeather({
        ...
        city: city || "data not found", // Fallback to Haridwar if city name fails
      });
    } catch (error) {
      ...
      >
        ...
        <TouchableOpacity style={styles.streakCardMain}>
          ...
          >
            {/* Corner Glows */}
            <LinearGradient
              colors={["rgba(241, 172, 45, 0.3)", "transparent"]}
              style={[styles.cornerGlow, { top: -20, right: -20 }]}
            />
            <LinearGradient
              colors={["rgba(214, 227, 29, 0.2)", "transparent"]}
